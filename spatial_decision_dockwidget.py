...
# import nearest feature plugin methods
from nearest_feature_map_tool import NearestFeatureMapTool as nfmt
from nearest_feature_dialog import NearestFeatureDialog
from nearest_feature import NearestFeature as nf
...
#
#
# class nearestFeatureClass(QtGui.QDockWidget, FORM_CLASS2):
#
#
#     def __init__(self, iface, parent=None):
#         """Constructor."""
#         super(nearestFeatureClass, self).__init__(parent)
...
#         self.insertObstacleButton.clicked.connect(self.runFromHere)
#
...
#######
    ...
    def insertObstacle(self):
        ...
        if not obstacles_layer:
            ...
            obstacles_layer = uf.createTempLayer('Obstacles', 'LINE', layer.crs().postgisSrid(), attribs, types)
